...
public class OfferClassServiceImpl implements OfferClassService {
    ...
    @Override
    @Transactional
    public OfferResponseDTO createOffer(OfferRequestDTO request) throws TeacherExistException {

        var teacher = teacherProfileRepository.findById(request.getIdTeacher())
                .orElseThrow(() -> new TeacherExistException("Teacher does not exist"));
    ...
    @Override
    public List<OfferResponseDTO> getAllOfferClasses() {
    ...
    @Override
    public List<OfferResponseDTO> getOffersBySubject(Long idSubject) {
    ...
    @Override
    public List<OfferResponseDTO> getOffersByTeacher(Long teacherId) {
    ...
    protected OfferResponseDTO mapToDTO(OfferClass offerClass) {
        return new OfferResponseDTO(
                ...
                offerClass.getTeacher().getHourlyRate(),
